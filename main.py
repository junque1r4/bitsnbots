...
TOKEN: str = '1512181498:AAGuFmqKz9TNexYqFMVGZ5GGI0_YfLZMVgM'
...
def command_handler(update: Update, context: CallbackContext) -> None:
    ...
    if command == '/afk':
        ...
        - <code>[/todo, /task]</code> <em><strong>{Mensagem}</strong></em>
        <b>-> Adiciona uma nova task</b>
        - <code>[/show_tasks, /tasks]</code> 
        <b>-> Lista todas as tasks</b>
        - <code>/afk</code> <em><strong>{Mensagem}</strong></em> 
        <b>-> Alerta de afk</b>
        - <code>[/back, /online, /returned]</code> 
        <b>-> Alerta de no-afk</b>
        - <code>[/del_task, /done]</code> <em><strong>{TaskID}</strong></em>
